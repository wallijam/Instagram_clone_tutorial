  ...
  <div id="app">
    <div class="app-phone">
      <div class="phone-header">
        <img src="<a href="<a href="https://ibb.co/pJbTDhv"><img src="https://i.ibb.co/qk78GJM/Screenshot-2019-05-19-16-09-03.png" alt="Screenshot-2019-05-19-16-09-03" border="0" /></a>
        <a class="cancel-cta"
           v-if="step === 2 || step === 3" 
           @click="goToHome">
            Cancel
